...
function Inner() {
  ...
  useEffect(() => {
    ...
    const geometry1 = new THREE.LatheGeometry(points1);
    ...
    const geometry2 = new THREE.LatheGeometry(
      points2,
      12, // ui: segments,
    ...
    const geometry3 = new THREE.LatheGeometry(
      points3,
      15.7, // ui: segments,
      Math.PI * 0.4, // ui: phiStart,
      Math.PI * 1.75 // ui: phiLength
    );
