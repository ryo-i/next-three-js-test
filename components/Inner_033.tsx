...
function Inner() {
  ...
  useEffect(() => {
    ...
    const material1 = new THREE.MeshStandardMaterial({
      color: 0x00FFFF,    // red (can also use a CSS color string here)
      // flatShading: true,
      roughness: 0.3,
      metalness: 0.3,
      emissive: 0x222222
    ...
    const primitives = [
      makeInstance(geometry, material1,  -15),
      makeInstance(geometry, material2, 0),
      makeInstance(geometry, material3,  15),
    ];
