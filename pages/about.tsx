    ...
    return (
        ...
        <Main>
            ...
            <section>
                <h2>進捗</h2>
                <ul>
                    <li>geometry1の引数を直接書く方法に変更 <a href="https://github.com/ryo-i/next-app-started/issues/8">#8</a></li>
                    <li>indexページを動的に生成 <a href="https://github.com/ryo-i/next-app-started/issues/3">#3</a></li>
